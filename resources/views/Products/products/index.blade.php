        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    ...
                    @can('add-'.str_slug('Products'))
                        <a class="btn btn-success pull-right" href="{{ url('/products/create') }}"><i
                            ...
                            @foreach($products as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @can('delete-'.str_slug('Products'))
                                            <form method="POST"
                                                  action="{{ url('/products' . '/' . $item->id) }}"
