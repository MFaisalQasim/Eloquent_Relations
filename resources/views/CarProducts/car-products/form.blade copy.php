<div class="form-group {{ $errors->has('car_id') ? 'has-error' : ''}}">
    ...
    <div class="col-md-6">
        <input class="form-control" name="car_id" type="number" id="car_id" value="{{ $carproduct->car_id or ''}}" required>
    ...
    <div class="col-md-6">
        <input class="form-control" name="product_id" type="number" id="product_id" value="{{ $carproduct->product_id or ''}}" required>
